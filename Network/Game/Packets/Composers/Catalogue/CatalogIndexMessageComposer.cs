...
namespace AuroraEmu.Network.Game.Packets.Composers.Catalogue
{
    public class CatalogIndexMessageComposer : MessageComposer
    {
        ...
        {
            IReadOnlyList<CatalogPage> categories = Engine.Locator.CatalogController.GetPages(0);
        ...
        {
            IReadOnlyList<CatalogPage> children = Engine.Locator.CatalogController.GetPages(page.Id);
