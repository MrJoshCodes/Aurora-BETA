...
namespace AuroraEmu.Network.Game.Packets.Events.Users.Clothing
{
    public class UpdateFigureDataMessageEvent : IPacketEvent
    {
        public void Run(Client client, MessageEvent msgEvent)
        {
            ...
            Engine.Locator.AchievementController.UpdateAchievementProgress(client, "ACH_AvatarLooks");
            Engine.Locator.AchievementController.CheckAchievement(client, "ACH_AvatarLooks");
        }
    }
}
